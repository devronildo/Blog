...
@section('scripts')
    <div id="fb-root"></div>
    <script async defer
            src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v3.2&appId=ARAlBFIu_DfKMC6IR5XomQfOg7C6aL-_JsBV4aNH-pV2kR5f0WJB3ZQKuIeNUznK8i57CPyPRijIm9qR&autoLogAppEvents=1"></script>
@endsection
